...
#         y_pred_valid = Logistic_regressor.predict(fold1_val_features)
#         y_pred_train = Logistic_regressor.predict(fold1_train_features)
...
#             joblib.dump(Logistic_regressor, f'./pkl/LR_fat_model.pkl')
