...
fold1_train_data = pd.read_csv('../../feature_selection/selected_fat_fold_data/fold_1/selected_train_data_1.csv')
...
fold1_val_data = pd.read_csv('../../feature_selection/selected_fat_fold_data/fold_1/selected_val_data_1.csv')
...
for C in C_values:
    for kernel in kernel_values:
        ...
        y_pred_valid = svm_classifier.predict(fold1_val_features)
        y_pred_train = svm_classifier.predict(fold1_train_features)
        ...
        if auc_valid > best_auc:
            ...
            joblib.dump(svm_classifier, './pkl/svm_fat_model.pkl')
print(best_params)
...
for fold in range(1, 11):
    ...
    train_data = pd.read_csv(f'../../feature_selection/selected_fat_fold_data/fold_{fold}/selected_train_data_{fold}.csv')
    val_data = pd.read_csv(f'../../feature_selection/selected_fat_fold_data/fold_{fold}/selected_val_data_{fold}.csv')
    test0_data = pd.read_csv(f"../../feature_selection/selected_fat_fold_data/fold_{fold}/selected_test0_data_{fold}.csv")
    test1_data = pd.read_csv(f"../../feature_selection/selected_fat_fold_data/fold_{fold}/selected_test1_data_{fold}.csv")
    test2_data = pd.read_csv(f"../../feature_selection/selected_fat_fold_data/fold_{fold}/selected_test2_data_{fold}.csv")
    ...
    support_vector_machine = SVC(C=1, kernel='linear', probability=True)
